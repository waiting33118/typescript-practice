...
/*
  ...
  never 型別的概念是程序在函式或方法執行時
    ...
    出現例外結果中斷執行
*/
var runForever = function forever() {
    while (true) {
    }
};
...
function tryRandom(num) {
    while (num > 5) {
        throw new Error('OOPS');
    }
    return num;
}
var random1 = tryRandom(randomNumber);
tryRandom(6);
tryRandom(4);
...
*/
function possibleNotToThrowError() {
